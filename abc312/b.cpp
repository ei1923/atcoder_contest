        ...
        for(int j=0;j<m;j++){
            ...
            for(int ii=0;ii<3;ii++){
                for(int jj=0;jj<3;jj++){
                    if(s[i+ii][j+jj]!='#') ans=false;
                    if(s[i+8-ii][j+8-jj]!='#') ans=false;
                }
            }

            for(int i2=0;i2<4;i2++){
                if(s[i+i2][j+3]!='.') ans=false;
                if(s[i+3][j+i2]!='.') ans=false;
                if(s[i+8-i2][j+8-3]!='.') ans=false;
                if(s[i+8-3][j+8-i2]!='.') ans=false;
            }
            if(ans) cout <<i+1<<" "<<j+1<<"\n";
        }
    }
